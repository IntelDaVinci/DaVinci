...
#ifndef __FFRD_TILTING_TEST_HPP__
#define __FFRD_TILTING_TEST_HPP__
...
namespace DaVinci
{
	class FfrdTiltingTest : public TestInterface
	{        
	private:
	...
	public:
        ...
        /// </summary>
        explicit FfrdTiltingTest();

		virtual ~FfrdTiltingTest();
        ...
        /// <summary>
		/// Third type cycling test function.
		/// </summary>
		/// <param name="frame">Frame to be processed</param>
		/// <returns></returns>
		virtual void ThirdTypeCyclingTest(const cv::Mat &frame);

        /// <summary>
		/// Fourth type cycling test function.
		/// </summary>
		/// <param name="frame">Frame to be processed</param>
		/// <returns></returns>
		virtual void FourthTypeCyclingTest(const cv::Mat &frame);
