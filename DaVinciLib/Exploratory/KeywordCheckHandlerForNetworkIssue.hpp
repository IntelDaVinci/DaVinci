...
#ifndef _NETWORKISSUERECOGNIZER_
#define _NETWORKISSUERECOGNIZER_
...
namespace DaVinci
{
    class KeywordCheckHandlerForNetworkIssue : public KeywordCheckHandler
    {
    public:
        KeywordCheckHandlerForNetworkIssue(boost::shared_ptr<KeywordRecognizer> keywordRecog);
