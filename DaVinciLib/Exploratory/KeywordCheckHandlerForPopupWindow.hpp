...
#ifndef _POPUPWINDOWCOGNIZER_
#define _POPUPWINDOWCOGNIZER_
...
namespace DaVinci
{
    class KeywordCheckHandlerForPopupWindow : public KeywordCheckHandler
    {
    public:
        KeywordCheckHandlerForPopupWindow(boost::shared_ptr<KeywordRecognizer> keywordRecog);
    ...
    private:
        ...
        std::vector<Keyword> enWindowKeyword;
        std::vector<Keyword> zhWindowKeyword;
    };
}
