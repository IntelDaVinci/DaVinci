...
#ifndef _ABNORMALFONTRECOGNIZER_
#define _ABNORMALFONTRECOGNIZER_
...
namespace DaVinci
{
    class KeywordCheckHandlerForAbnormalFont : public KeywordCheckHandler
    {
    public:
        KeywordCheckHandlerForAbnormalFont(boost::shared_ptr<KeywordRecognizer> keywordRecog);
