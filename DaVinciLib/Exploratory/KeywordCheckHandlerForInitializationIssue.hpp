...
#ifndef _INITIALIZATIONISSUERECOGNIZER_
#define _INITIALIZATIONISSUERECOGNIZER_
...
namespace DaVinci
{
    class KeywordCheckHandlerForInitializationIssue : public KeywordCheckHandler
    {
    public:
        KeywordCheckHandlerForInitializationIssue(boost::shared_ptr<KeywordRecognizer> keywordRecog);
