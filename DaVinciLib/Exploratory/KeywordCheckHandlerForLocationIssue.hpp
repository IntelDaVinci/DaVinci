...
#ifndef _LOCATIONISSUEERECOGNIZER_
#define _LOCATIONISSUEERECOGNIZER_
...
namespace DaVinci
{
    class KeywordCheckHandlerForLocationIssue : public KeywordCheckHandler
    {
    public:
        KeywordCheckHandlerForLocationIssue(boost::shared_ptr<KeywordRecognizer> keywordRecog);
