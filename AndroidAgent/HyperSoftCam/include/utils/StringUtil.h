...
public:
    ...
    static Vector<android::String8> split(const android::String8& str, char delimiter);
    ...
    static bool startsWith(const android::String8& str, const char* other);
    static android::String8 trimLeft(const android::String8& str);
    static int strToInt(const android::String8& str);
};
