...
if __name__ == '__main__':
    ...
    result = xml_object.getTextsByTagName("installation_times")

    installation_times = int(result[0]) if result else 1
    ...
    para['running_times'] = installation_times
    ...
    try:
        installation = performance.InstallationGenerator(**para).get_tester()
        installation.start()
    except Exception as e:
        s = sys.exc_info()
